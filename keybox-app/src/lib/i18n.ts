  ...
  en: {
    translation: {
      ...
      password: {
        ...
        totalCount: "{{count}} passwords total",
        showingAll: "Showing all {{count}} passwords",
        filterResults: "Filter results: {{count}} passwords",
        searchInFilter: ' (search: "{{query}}")',
        welcomeTitle: "Welcome to PandaKeyBox",
        welcomeDescription:
          "You haven't saved any passwords yet. Start creating your first password entry and let PandaKeyBox help you securely manage all your passwords.",
        startManaging: "Start Managing Passwords",
        importExisting: "Import Existing Passwords",
        // Add password page
        ...
        confirmClear: "Are you sure you want to clear all input?",
        ...
        titlePlaceholder2: "Enter password entry title",
      ...
      category: {
        ...
        confirmDeleteCategory:
          "Are you sure you want to delete this category? All entries in this category will become uncategorized.",
        fieldsCount: "{{count}} fields",
        fieldsCount_one: "{{count}} field",
        fieldsCount_other: "{{count}} fields",
        moreFields: "+{{count}} more",
        selectTemplateHint:
          "Select a template to quickly create common category types",
        includesFields: "Includes {{count}} preset fields",
        includesFields_one: "Includes {{count}} preset field",
        includesFields_other: "Includes {{count}} preset fields",
        addFromTemplate: "Add",
        ...
        templates: {
          general: {
            name: "General",
            description: "General type, suitable for various information",
            fields: {
              title: "Title",
              content: "Content",
              notes: "Notes",
          ...
          website: {
            ...
            description: "Login accounts for websites and applications",
            fields: {
              username: "Username",
              password: "Password",
              website: "Website URL",
          ...
          database: {
            ...
            fields: {
              ...
              username: "Username",
              password: "Password",
              hostPlaceholder: "localhost or IP address",
          ...
          bankCard: {
            name: "Bank Card",
            description: "Bank card and financial account information",
            fields: {
              ...
              pinPlaceholder: "Withdrawal PIN",
              bankNamePlaceholder: "Issuing bank",
            },
          },
          personal: {
            name: "Personal Information",
            description: "Personal important information and anniversaries",
            fields: {
              name: "Name",
              birthday: "Birthday",
              phone: "Phone",
          ...
          server: {
            name: "Server",
            description: "Server and remote connection information",
            fields: {
              host: "Host Address",
              port: "Port",
              username: "Username",
              ...
              privateKeyPlaceholder: "SSH private key content",
            },
          },
          wifi: {
            name: "WiFi",
            description: "WiFi network connection information",
            fields: {
              ssid: "Network Name",
              password: "Password",
              ...
              securityPlaceholder: "WPA2/WPA3",
              locationPlaceholder: "Network location",
            },
          },
        },
        // Validation messages
        validation: {
          ...
          iconRequired: "Category icon cannot be empty",
          colorRequired: "Category color cannot be empty",
          fieldsRequired: "At least one field is required",
          fieldNameRequired: "Field {{index}} name cannot be empty",
          duplicateFieldNames: "Field names cannot be duplicated",
        },
        // Field types
        fieldTypes: {
          text: "Text",
  ...
  zh: {
    translation: {
      ...
      password: {
        ...
        strong: "强",
        veryStrong: "很强",
        totalCount: "共 {{count}} 个密码",
        showingAll: "显示全部 {{count}} 个密码",
        filterResults: "筛选结果：{{count}} 个密码",
        searchInFilter: '（搜索："{{query}}"）',
        welcomeTitle: "欢迎使用 PandaKeyBox",
        welcomeDescription:
          "您还没有保存任何密码。开始创建您的第一个密码条目，让 PandaKeyBox 帮您安全管理所有密码。",
        startManaging: "开始管理密码",
        importExisting: "导入现有密码",
        // Add password page
        addPassword: "添加密码",
        basicInfo: "基本信息",
        titleRequired: "标题 *",
      ...
      category: {
        ...
        categoryColor: "类目颜色",
        categoryIcon: "类目图标",
        categoryManager: "类目管理",
        myCategories: "我的类目",
        templateLibrary: "模板库",
        addNewCategory: "添加新类目",
        confirmDeleteCategory:
          "确定要删除这个类目吗？删除后该类目下的所有条目将变为未分类。",
        fieldsCount: "{{count}} 个字段",
        fieldsCount_one: "{{count}} 个字段",
        fieldsCount_other: "{{count}} 个字段",
        moreFields: "+{{count}} 更多",
        selectTemplateHint: "选择模板快速创建常用类型的类目",
        includesFields: "包含 {{count}} 个预设字段",
        includesFields_one: "包含 {{count}} 个预设字段",
        includesFields_other: "包含 {{count}} 个预设字段",
        addFromTemplate: "添加",
        saveChanges: "保存更改",
        cancel: "取消",
        edit: "编辑",
        ...
        templates: {
          ...
          database: {
            ...
            fields: {
              ...
              username: "用户名",
              password: "密码",
              hostPlaceholder: "localhost 或 IP 地址",
              portPlaceholder: "3306",
          ...
          server: {
            ...
            fields: {
              ...
              privateKeyPlaceholder: "SSH 私钥内容",
            },
          },
          wifi: {
            name: "WiFi",
            ...
            fields: {
              ...
              security: "加密方式",
              location: "位置",
              ssidPlaceholder: "WiFi 名称 (SSID)",
              passwordPlaceholder: "WiFi 密码",
              securityPlaceholder: "WPA2/WPA3",
              locationPlaceholder: "网络位置",
            },
          },
        },
        // Validation messages
        validation: {
          nameRequired: "类目名称不能为空",
          iconRequired: "类目图标不能为空",
          colorRequired: "类目颜色不能为空",
          fieldsRequired: "至少需要一个字段",
          fieldNameRequired: "第 {{index}} 个字段名称不能为空",
          duplicateFieldNames: "字段名称不能重复",
        },
        // Field types
        fieldTypes: {
          text: "文本",
